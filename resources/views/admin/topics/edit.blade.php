                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-4">
                            <div class="form-group">
                                ...
                                <input id="title" type="text" class="form-control" value="{{$topic->title}}" name="title" required >
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4">
                            <div class="form-group">
                                ...
                                <input value="{{ $topic->question_points }}" id="question_points" type="number" class="form-control " name="question_points" required>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4">
                            <div class="form-group">
                                ...
                                <input value="{{ $topic->exercise_points }}" id="exercise_points" type="number" class="form-control " name="exercise_points" required>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4">
                            <div class="form-group">
                                ...
                                <input value="{{ $topic->exercise_points_correct }}" id="exercise_points_correct" type="number" class="form-control " name="exercise_points_correct" required>
                            </div>
                        </div>
