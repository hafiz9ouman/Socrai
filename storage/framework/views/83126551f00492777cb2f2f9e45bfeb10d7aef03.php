                ...
                if ( result.value == true ) {
                    $.ajax( {
                        ...
                        success: function ( msg ) {
                            swal( "<?php echo app('translator')->get('Request is rejected'); ?>", '', 'success' )
                            setTimeout( function () {
                                location.reload();
                            }, 900 );
                        }
            ...
            swal({
                ...
                if ( result.value == true ) {
                    $.ajax( {
                        ...
                        data: form_data,
                        success: function ( msg ) {
                            swal( "<?php echo app('translator')->get('User joined tribe successfully'); ?>", '', 'success' )
                            setTimeout( function () {
                                location.reload();
                            }, 900 );
                        }
...
<?php echo $__env->make( 'admin.layouts.app' , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\socrai.com8\socrai.com\resources\views/admin/tribe/join_requests.blade.php ENDPATH**/ ?>