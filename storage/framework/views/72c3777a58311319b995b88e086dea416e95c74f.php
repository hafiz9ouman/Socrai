...
<div class="row">
	<div class="col-md-12">
			...
			<div class="tile">
				...
				<form class="form-horizontal" method="POST" action="<?php echo e(url('/update-profile-post')); ?>" enctype="multipart/form-data">
					...
					<div class="row">
						...
						<div class="col-sm-6 col-md-4">
							<div class="form-group">
								...
								<input id="email"  type="email" readonly class="form-control " name="email" value="<?php echo e($user->email); ?>"  >
							</div>
						</div>
	...
	<?php endif; ?>
                    ...
                    <?php if(Auth::check()): ?>
                        <div class="tile-footer text-right " >
                            <a href="<?php echo e(url('users')); ?>" class="btn btn-primary"><?php echo app('translator')->get('general.cancel'); ?></a>
                            <button type="submit" class="btn btn-success"><?php echo app('translator')->get('general.save'); ?></button>
                        </div>
                    <?php endif; ?>
				</form>
...
<?php echo $__env->make( 'admin.layouts.app' , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Socrai\resources\views/admin/users/update_profile.blade.php ENDPATH**/ ?>