  ...
  <a href="/update-profile/<?php echo e(auth()->user()->id); ?>"><div class="app-sidebar__user"><img class="app-sidebar__user-avatar" style="width: 83px; height: 83px;" src="<?php echo e(env('APP_URL')); ?>/images/sucrai/<?php echo e(Auth::user()->image); ?>" alt="User Image">
    <div>
      ...
      <div class="app-sidebar__user">
        ...
        <img class="app-sidebar__user-avatar" src="<?php echo e(env('APP_URL')); ?>public/images/sucrai/abc.png" alt="User Image" style="width: 83px; height: 83px;">
...
</aside><?php /**PATH F:\xampp\htdocs\socrai.com8\socrai.com\resources\views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>