    ...
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                ...
                <?php endif; ?>
                <h3 class="tile-title">Add Socrai Leaders
                <?php if(Auth::check() ): ?>
           ...
           <?php if($row->image == ''): ?>
            ...
            <?php endif; ?>
                                    ...
                                    <td>
                                            <small> <?php echo e($row->city); ?></small>
                                    </td>


                                    <td>
                                            <small> <?php echo e($row->state); ?></small>
                                    </td>
                                    <td>
                                            <small> <?php echo e($row->country); ?></small>
                                    </td>


                                    <td class="text-center">
                                        <div class="actions-btns dule-btns float-lg-right">
                                            <a href="<?php echo e(url('/socraileader/make/' . $row->id)); ?>" class="btn btn-sm btn-info" style="float: left;"><i class="fa fa-question"></i><small>  Make Socrai Leader</small></a>
                                        </div>
                                    </td>
                                </tr>
