                                    ...
                                    <td style="text-transform: none;">
                                        <?php if($row->media_type == 'external'): ?>
                                            ...
                                            <?php if($filetype == 'mp3'): ?>
                                                ...
                                                <img src="<?php echo e(url('/audio-placeholder.png')); ?>"
                                            ...
                                            <?php else: ?>
                                                <img src="<?php echo e(url('/play.png')); ?>"
                                                    style="width:50px;cursor: pointer;" data-fancybox
                                                    data-src="#hidden-content-a<?php echo e($counter); ?>" href="javascript:;" />
                                                <div style="display: none;" id="hidden-content-a<?php echo e($counter); ?>">
                                        ...
                                        <?php else: ?>
                                            <?php if(file_exists(public_path($row->media))): ?>
                                                <?php if(in_array($row->media_type, $image_type)): ?>
                                                    ...
                                                    <a href="<?php echo e(url('' . $row->media)); ?>" data-fancybox="images"
                                                        data-caption="">
                                                        <img src="<?php echo e(url('' . $row->media)); ?>"
                                                            style="width:50px" />
                                                    </a>

                                                <?php elseif( in_array( $row->media_type, $video_type) ): ?>
                                                    
                                                    <img src="<?php echo e('/play.png'); ?>" style="width:50px;cursor: pointer;"
                                                        data-fancybox data-src="#hidden-content-a<?php echo e($counter); ?>"
                                                        href="javascript:;" />
                                                    <div style="display: none;" id="hidden-content-a<?php echo e($counter); ?>">
                                                        <video controls poster="<?php echo e('/play.png'); ?>" width="320"
                                                            height="240">
                                                            <source src="<?php echo e(url('' . $row->media)); ?>" type="video/mp4">
                                                ...
                                                <?php elseif( in_array( $row->media_type, $audio_type) ): ?>
                                                    ...
                                                    <div style="display: none;" id="hidden-content-a<?php echo e($counter); ?>">
                                                        <audio controls autostart="0" autostart="false" preload="none">
                                                            <source src="<?php echo e(url('' . $row->media)); ?>"
                                                                type="audio/mpeg">
                                                            Your browser does not support the audio element.
                                                        </audio>
                                                    </div>
                ...
                if (result.value == true) {
                    $.ajax({
                        ...
                        success: function(msg) {
                            swal("<?php echo app('translator')->get('Question Deleted Successfully'); ?>", '', 'success')
                            setTimeout(function() {
                                location.reload();
                            }, 900);
                        }
...
<?php echo $__env->make( 'admin.layouts.app' , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Socrai\resources\views/admin/question-answers/home-fast.blade.php ENDPATH**/ ?>