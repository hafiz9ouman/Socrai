                              ...
                              <div class="form-group ">
                                ...
                                <select name="exercise_id" class="form-control "  required >
                                    ...
                                    <?php $__currentLoopData = $exercise; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($data->id); ?>"><?php echo $data->question ?></option>
...
<?php echo $__env->make( 'admin.layouts.app' , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Socrai\resources\views/admin/question-answers/add-to-exercise.blade.php ENDPATH**/ ?>