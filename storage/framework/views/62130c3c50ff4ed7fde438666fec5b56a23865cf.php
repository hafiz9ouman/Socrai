                    ...
                    <table id = "example" class="table">
                        ...
                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr  {{ <?php if($data != 'false'): ?> < 1)  <?php endif; ?> >
                                ...
                                <td>
                                    <img class=" img-circle img-size-32 mr-2 round_img"  height="15%" src="<?php echo e(env('APP_URL')); ?>public/images/sucrai/<?php if(isset($row->leader->image)) echo $row->leader->image; ?>" style=" height: 70px !important;
            width: 68px;
            border-radius: 30px; ">
                                </td>
                                <td>
...
<?php echo $__env->make( 'admin.layouts.app' , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\socrai.com8\socrai.com\resources\views/admin/tribe-leader/tribe-leaders.blade.php ENDPATH**/ ?>