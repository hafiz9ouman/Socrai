                        ...
                        <table  class="table table-hover">
                                ...
                                <tbody id="myTable">
                                         ...
                                         <tr>
                                                ...
                                                <td>
                                            <img class=" img-circle img-size-32 mr-2 round_img" height="15%" src="/public/images/sucrai/<?php echo e($data->image); ?> " style=" height: 70px !important;width: 68px;
            border-radius: 30px;">
                                                </td>
                    ...
                    <?php if(Auth::check()): ?>
                        <div class="tile-footer text-right " >
                            <a href="<?php echo e(route('tribes')); ?>" class="btn btn-default"><?php echo app('translator')->getFromJson('general.cancel'); ?></a>
                            <button type="submit" id="subm" class="btn btn-primary"><?php echo app('translator')->getFromJson('general.save'); ?></button>
                        </div>
                    <?php endif; ?>
                </form>
