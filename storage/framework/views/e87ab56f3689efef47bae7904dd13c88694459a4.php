                    ...
                    <table id = "example" class="table">
                        ...
                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr >
                                ...
                                <td>
                                    <?php if($row->image !=""): ?>
                                    <img class=" img-circle img-size-32 mr-2 round_img" height="15%" src="public/images/sucrai/<?php echo e($row->image); ?>" style=" height: 70px !important; width: 68px;border-radius: 30px; ">
                                    <?php else: ?>
            ...
            swal({
                ...
                if ( result.value == true ) {
                    $.ajax( {
                        ...
                        data: form_data,
                        success: function ( msg ) {
                            swal( "<?php echo app('translator')->getFromJson('Admin Deleted Successfully'); ?>", '', 'success' )
                            setTimeout( function () {
                                location.reload();
                            }, 900 );
                        }
