                ...
                <form class="form-horizontal" method="POST" action="<?php echo e(url('/pages/update')); ?>" enctype="multipart/form-data">
                    ...
                    <?php if(Auth::check()): ?>
                        <div class="tile-footer text-right " >
                            <a href="<?php echo e(url('pages')); ?>" class="btn btn-default"><?php echo app('translator')->get('general.cancel'); ?></a>
...
<?php echo $__env->make( 'admin.layouts.app' , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\socrai.com8\socrai.com\resources\views/admin/pages/pages.blade.php ENDPATH**/ ?>