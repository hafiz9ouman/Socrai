                ...
                <form class="form-horizontal" method="POST" action="<?php echo e(url('site_admin/store')); ?>" enctype="multipart/form-data">
                    ...
                    <?php if(Auth::check()): ?>
                        <div class="tile-footer text-right " >
                            <a href="<?php echo e(url('site_admin')); ?>" class="btn btn-default"><?php echo app('translator')->get('general.cancel'); ?></a>
...
<?php echo $__env->make( 'admin.layouts.app' , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Socrai\resources\views/admin/users/admin_add.blade.php ENDPATH**/ ?>