                ...
                if ( result.value == true ) {
                    $.ajax( {
                        ...
                        success: function ( msg ) {
                            swal( "<?php echo app('translator')->get('User Deleted Successfully'); ?>", '', 'success' )
                            setTimeout( function () {
                                location.reload();
                            }, 900 );
                        }
...
<?php echo $__env->make( 'admin.layouts.app' , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Socrai\resources\views/admin/users/edit.blade.php ENDPATH**/ ?>