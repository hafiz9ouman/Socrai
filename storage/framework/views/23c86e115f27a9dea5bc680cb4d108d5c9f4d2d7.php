                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input id="question" type="text" class="form-control" value="<?php echo e($data->question); ?>" name="question" required>
                        </div>
                        ...
                        <fieldset class="answerr">
                            ...
                            <option value=null> <?php if($attach_flag != null): ?> <?php echo e($attach_flag->question); ?> <?php endif; ?></option>
                            ...
                            <option value="<?php echo e($datum->id); ?> "><?php echo e($datum->question); ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" rows="3" id="answer" name="answer" placeholder="Please enter answer." required><?php echo e($data->answer); ?></textarea>
                        </div>
                        ...
                        <div class="form-group" id="upload_media_image">
                            <?php if( $data->media_type != "external" && in_array($data->media_type, $image_type)): ?>
                                <img src="<?php echo e(url('public/'.$data->media)); ?>" width="100" height="100">
                            ...
                            <video controls poster="<?php echo e(url('public/play.png')); ?>" width="320" height="240">
                                <source src="<?php echo e(url('public/'. $data->media)); ?>" type="video/mp4">
                                Your browser does not support the video tag.
                            </video>
                            <?php elseif( $data->media_type != "external" && in_array( $data->media_type, $audio_type) ): ?>
                            <audio controls>
                                <source src="<?php echo e(url('public/'.$data->media)); ?>" type="audio/mpeg">
