                ...
                if ( result.value == true ) {
                    $.ajax( {
                        ...
                        success: function ( msg ) {
                            ...
                            setTimeout( function () {
                                window.location.href = "<?php echo e(url('tribes')); ?>";
                            }, 900 );
                        }
                    } );
                }
...
<?php echo $__env->make( 'admin.layouts.app' , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Socrai\resources\views/admin/tribe/edit_tribe.blade.php ENDPATH**/ ?>