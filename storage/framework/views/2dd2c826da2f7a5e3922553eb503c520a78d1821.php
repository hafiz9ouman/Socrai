                        ...
                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                             ...
                             <?php if($row->mediatype == 'jpg' || $row->mediatype == 'png'): ?>
                                ...
                                <a href="https://dev.socrai.com/media/questions_answers/<?php echo e($row->file); ?>" data-fancybox="images" data-caption="">
                                    <img src="https://dev.socrai.com/media/questions_answers/<?php echo e($row->file); ?>" style="width:50px" />
                                </a>
                             <?php elseif($row->mediatype == 'mp3'): ?>   
                            
                                <img src="<?php echo e(url('/audio-placeholder.png')); ?>" style="width:50px;cursor: pointer;" data-fancybox data-src="#hidden-content-a<?php echo e($counter); ?>" href="javascript:;" />
                                        <div style="display: none;" id="hidden-content-a<?php echo e($counter); ?>">
                                            <audio controls  autostart="0" autostart="false" preload ="none">
                                                <source src="https://dev.socrai.com/media/questions_answers/<?php echo e($row->file); ?>" type="audio/mpeg">
                                                Your browser does not support the audio element.
                                            </audio>
                                        </div>

                             <?php else: ?>
                              <img src="<?php echo e('https://dev.socrai.com//play.png'); ?>" style="width:50px;cursor: pointer;" data-fancybox data-src="#hidden-content-a<?php echo e($counter); ?>" href="javascript:;" />
                                        <div style="display: none;" id="hidden-content-a<?php echo e($counter); ?>">
                                            <video controls="controls" data-autoplayvideo="false"  data-playvideoonclick="false" sandbox frameborder="0" scrolling="no" marginheight="0" marginwidth="0" width="500" height="300" src="https://dev.socrai.com/media/questions_answers/<?php echo e($row->file); ?>"></video>
                                        </div>
                               <?php endif; ?>
                ...
                if ( result.value == true ) {
                    $.ajax( {
                        ...
                        success: function ( msg ) {
                            swal( "<?php echo app('translator')->get('Media Deleted Successfully'); ?>", '', 'success' )
                            setTimeout( function () {
                                location.reload();
                            }, 900 );
                        }
...
<?php echo $__env->make( 'admin.layouts.app' , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Socrai\resources\views/admin/question-answers/media_home.blade.php ENDPATH**/ ?>