                    ...
                    <table id = "example2" class="table">
                        ...
                        <?php $__currentLoopData = $datum; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr >
                                ...
                                <td>
                                    <?php if($user->image !=""): ?>
                                    <img class=" img-circle img-size-32 mr-2 round_img" height="15%" src="/images/sucrai/<?php echo e($user->image); ?>" style=" height: 70px !important; width: 68px;border-radius: 30px; ">
                                    <?php else: ?>
...
<?php echo $__env->make( 'admin.layouts.app' , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Socrai\resources\views/admin/users/siteadmin_home.blade.php ENDPATH**/ ?>