...
<aside class="app-sidebar">
  ...
  <a href="/update-profile/<?php echo e(auth()->user()->id); ?>"><div class="app-sidebar__user"><img class="app-sidebar__user-avatar" style="width: 83px; height: 83px;" src="<?php echo e(env('APP_URL')); ?>/images/sucrai/<?php echo e(Auth::user()->image); ?>" alt="User Image">
    <div>
    </a>
      <?php else: ?>
      ...
      <div class="app-sidebar__user">
        ...
        <img class="app-sidebar__user-avatar" src="<?php echo e(env('APP_URL')); ?>/images/sucrai/abc.png" alt="User Image" style="width: 83px; height: 83px;">
...
<span class="app-menu__label"> Socrai Leaders</span></a></li>
        ...
        <li><a class="app-menu__item <?php if (Request::segment(1) == "media") echo "active"; ?>" href="<?php echo e(url('/media/home')); ?>"><i class="fa fa-file-image-o" aria-hidden="true"> </i><span class="app-menu__label"> Add Media</span></a></li>
        <?php endif; ?>
        ...
        <li><a href="<?php echo e(url('discussions')); ?>" class="app-menu__item <?php if (Request::segment(1) == "discussions") echo "active"; ?>" href="javascript:;"><i class="app-menu__icon fa fa-sign-out"></i><span class="app-menu__label">Discussions</span></a></li>
...
</aside><?php /**PATH C:\xampp\htdocs\Socrai\resources\views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>